		...
		return (
			<Wrapper>
				...
				>
					...
					<div style={{ width: '100%', height: 'auto', background: '#fff', borderRadius: '5px', boxShadow: '0 0 5px gray', padding: '50px', fontFamily: 'montserrat' }}>
						<main style={{ fontFamily: 'montserrat' }}>{children}</main>
					</div>
				</div>
				<Footer style={{ fontFamily: 'montserrat' }}>
					© {new Date().getFullYear()} M. Wahyudi, Built with
					{` `}
